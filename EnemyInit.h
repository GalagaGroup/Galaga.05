...
void EnemyInit(Enemy enemies[32], int a){
    ...
    //bottom left row
    enemies[0] = Enemy (50, a, 2);
    enemies[1] = Enemy (80, a, 2);
    enemies[2] = Enemy (110, a, 2);
    enemies[3] = Enemy (140, a, 2);
    enemies[4] = Enemy (170, a, 2);
    enemies[5] = Enemy (200, a, 2);
    enemies[6] = Enemy (230, a, 2);
    enemies[7] = Enemy (260, a, 2);
    ...
    //top left row
    enemies[16] = Enemy (50, a + 40, 2);
    enemies[17] = Enemy (80, a + 40, 2);
    enemies[18] = Enemy (110, a + 40, 2);
    enemies[19] = Enemy (140, a + 40, 2);
    enemies[20] = Enemy (170, a + 40, 2);
    enemies[21] = Enemy (200, a + 40, 2);
    enemies[22] = Enemy (230, a + 40, 2);
    enemies[23] = Enemy (260, a + 40, 2);
